...
public abstract class BaseTestNGReport {
	...
	protected String m_baseDirectory = String.format("%s/becreport",
	...
	protected void writeFrameHeader() {
		...
		m_writer.print("<tr>");
		m_writer.print("<td>");
		m_writer.print("<img src=\"benchmark.png\" alt=\"Bec\" />");
		m_writer.print("</td>");
	...
	// This method will verify Company  image is available or not and copies
	// that image.
	private void copyCompanyImage() {
		System.out.println();
		System.out.println();
