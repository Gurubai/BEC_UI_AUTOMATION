...
public abstract class BaseControl {
	...
	public BaseControl(String findByType, String valueToFindElement) {
		try {
			...
			Assert.assertTrue(false, CommonUtil.appendErrorCodeToMessage(String.format(
	...
	/**
	 * This method will return the child Elements Count based on type and value from
	 * the parent control
	 * 
	 * @param childFindByType  -> ChildFindByType
	 * @param childFindByValue -> ChildFindByValue
	...
	/**
	 * Get the text value from the current element without embedding child elements
	 * 
	...
	/**
	 * Gets ToolTip for that control. If ToolTip is not defined then it will return
	 * null.
	 * 
	 * @return
	 */
	 ...
	 */
	/*
	 * public boolean isVisible() { if (null == m_webElement) return false; try {
	 * SeleniumWrapper.sleep(); return m_webElement.isDisplayed(); } catch
	 * (StaleElementReferenceException elementHasDisappeared) { return false; } }
	 */
	 ...
	 * @since Dec 2, 2015
	 * 
	 * @param             <T> Data type of control element; must extend from
	 *                    BaseControl.
	 * @param findByType  Locator strategy (see {@link FindByTypeConstants})
	 * @param locator     String specifying the actual locator (relative to current
	 *                    element)
	 * @param controlType Class type for the return value
	...
	/**
	 * Find a list of child elements under the current element. This method provides
	 * a default delay of up to 5 seconds to find the child elements.
	 * 
	 * @param findByType  The locator strategy
	 * @param locator     The locator string for the child elements (should be
	 *                    relative to the parent element)
	 * @param controlType The subclass of {@link BaseControl} for the elements in
	 *                    the returned list
	 * 
	...
	public WebElement getdropdownelement(WebElement element) {
		...
		return element.findElement(By.xpath("//select[@class='field selectBox']"));
	}
